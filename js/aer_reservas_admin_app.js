(() => {
  // src/AppReservasAdmin/useAdminAjax.jsx
  ...
  var SelectLiveSearch = ({ srcArray, setFilter }) => {
    React.useEffect(() => {
      if (srcArray) {
        let createCustomDropdown = function(dropdown) {
          ...
          optionsArr.forEach((option) => {
            ...
            item.addEventListener(
              "click",
              ({ target }) => setFilter(target.dataset.varId)
            );
        ...
        }, setSelected = function(selected, dropdown, menu) {
        ...
        }, filterItems = function(itemsArr, menu) {
        ...
        }, closeIfClickedOutside = function(menu, e) {
    ...
    return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("form", { name: "countries", className: "live-search-form", id: "form" }, /* @__PURE__ */ React.createElement("div", { className: "form-group" }, /* @__PURE__ */ React.createElement("span", { className: "form-arrow" }, /* @__PURE__ */ React.createElement("i", { class: "bx bx-chevron-down" })), /* @__PURE__ */ React.createElement("select", { name: "country", id: "country", className: "live-search-dropdown" }, /* @__PURE__ */ React.createElement("option", { disabled: true }, "Filtre por excurs\xE3o..."), srcArray.map((item) => {
      return /* @__PURE__ */ React.createElement("option", { value: item[0], "data-var-id": item[2] }, item[0], " - ", item[1]);
    })))));
  };
  var SelectLiveSearch_default = SelectLiveSearch;

  // src/AppReservasAdmin/ItemReserva.jsx
  var ItemReserva = ({ reserva, excDetails, adminAjax }) => {
    const orderLink = `https://aerotour.com.br/wp-admin/post.php?post=${reserva.order_id}&action=edit`;
    const dia = excDetails ? excDetails["id_" + reserva.variation_id][1] : "";
    ...
    return /* @__PURE__ */ React.createElement("tr", { onClick: openOptionsMenu, "data-reserva-id": reserva.ID }, /* @__PURE__ */ React.createElement("td", { "data-coluna": "order-id" }, /* @__PURE__ */ React.createElement("a", { href: orderLink }, reserva.order_id)), /* @__PURE__ */ React.createElement("td", { "data-coluna": "excursao" }, excDetails ? excDetails["id_" + reserva.variation_id][0] : "", " -", " ", dia.substring(0, 5)), /* @__PURE__ */ React.createElement("td", { "data-coluna": "nome-completo" }, reserva.p_nome), /* @__PURE__ */ React.createElement("td", { "data-coluna": "cpf" }, reserva.p_cpf), /* @__PURE__ */ React.createElement("td", { "data-coluna": "telefone" }, reserva.p_telefone), /* @__PURE__ */ React.createElement("td", { "data-coluna": "embarque" }, reserva.embarque), /* @__PURE__ */ React.createElement("td", { "data-coluna": "horario" }, reserva.horario.slice(0, -3)), /* @__PURE__ */ React.createElement("td", { "data-coluna": "status" }, reserva.status));
  };
  ...
  function AppReservasAdmin({ ajaxUrl }) {
    ...
    React.useEffect(() => {
      excDetails ? setExcDetails2(Object.values(excDetails)) : null;
    }, [excDetails]);
    React.useEffect(() => {
      ...
      if (filter != "undefined" && filter != null) {
        ...
        thead_embarque ? thead_embarque.classList.add("sort-enabled") : null;
        sheetBtn.removeAttribute("disabled");
      } else {
        setReservas_f([]);
        thead_embarque ? thead_embarque.classList.remove("sort-enabled") : null;
    ...
    return /* @__PURE__ */ React.createElement("div", { id: "adminReservasTable" }, /* @__PURE__ */ React.createElement("div", { className: "filtros" }, /* @__PURE__ */ React.createElement("div", { className: "exc-search" }, excDetails2 ? /* @__PURE__ */ React.createElement(SelectLiveSearch_default, { srcArray: excDetails2, setFilter }) : "carregado excurs\xF5es..."), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => {
          const wb = utils.table_to_book(tableToSheetRef.current);
          writeFileSyncXLSX(wb, "SheetJSReactExport.xlsx");
        },
        id: "exportSheetBtn"
      },
      "Exportar XLS"
    )), reservas ? /* @__PURE__ */ React.createElement("p", null, reservas_f.length > 0 ? reservas_f.length : reservas.length, " reservas") : null, /* @__PURE__ */ React.createElement("table", { ref: tableToSheetRef }, /* @__PURE__ */ React.createElement("thead", null, /* @__PURE__ */ React.createElement("tr", null, /* @__PURE__ */ React.createElement("th", { "data-coluna": "order-id" }, "Pedido"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "excursao" }, "Excurs\xE3o"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "nome-completo" }, "Nome Completo"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "cpf" }, "CPF"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "telefone" }, "Telefone"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "embarque", onClick: ordenarPassageiros }, "Embarque"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "horario" }, "Hor\xE1rio"), /* @__PURE__ */ React.createElement("th", { "data-coluna": "status" }, "Status"))), /* @__PURE__ */ React.createElement("tbody", null, reservas && reservas_f.length > 0 ? reservas_f.map((reserva) => {
      return /* @__PURE__ */ React.createElement(ItemReserva_default, { reserva, excDetails });
    }) : null, reservas && reservas_f.length == 0 ? reservas.map((reserva) => {
  ...
  if (reserva_admin_app_root) {
    ReactDOM.createRoot(reserva_admin_app_root).render(
      /* @__PURE__ */ React.createElement(AppReservasAdmin, { ajaxUrl: reserva_admin_app_root.dataset.ajaxUrl })
    );
  }
})();
