...
(() => {
  ...
  var AppCheckInModalPax = ({ setModalPax, modalPax }) => {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pax-modal-backdrop", onClick: () => setModalPax(null), children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: modalPax.p_nome }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "CPF:" }),
            " ",
            modalPax.p_cpf
          ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Embarque:" }),
            " ",
            modalPax.embarque
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { className: "modal-close-btn", onClick: () => setModalPax(null), children: "Fechar" })
        ]
      }
    ) });
  };
  AppCheckInModalPax.propTypes = {
    setModalPax: import_prop_types.default.func.isRequired,
    modalPax: import_prop_types.default.oneOfType([import_prop_types.default.bool, import_prop_types.default.object]).isRequired
  };
  ...
  var AppCheckInModal = ({
    ...
    const toggleCheck = (paxId, sentido, valor, element) => {
      ...
      adminApiFetch(
        "check_in",
        { pax_id: paxId, sentido, valor: valor ? "1" : "0" },
        (success) => {
      ...
      adminApiFetch(
        ...
        (success, data) => {
          ...
          if (success && data?.atuais) {
            ...
            console.error("Erro ao obter excurs\xF5es:", data);
            setError("Erro ao obter excurs\xF5es");
            setExcursoes([]);
          }
          setLoading(false);
        },
        ...
        excursoes.map((_excursao) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("li", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "span",
            {
              ...
              onClick: () => openCheckInModal(_excursao.variation_id, {
                nome: _excursao.nome,
                dia: _excursao.dia
              })
            }
