	...
	<form method="post" class="woocommerce-ResetPassword lost_reset_password login-container">
		<div class="login-box">
				...
				<p class="woocommerce-form-row form-row">
					...
					<button type="submit" class="btn btn-small main-btn woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Reset password', 'woocommerce' ); ?>"><?php esc_html_e( 'Reset password', 'woocommerce' ); ?></button>
				</p>
