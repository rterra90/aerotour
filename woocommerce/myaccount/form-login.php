		...
		<div class="u-columns row" id="customer_login">
			...
			<div class="col-lg-5 col-12 registrar form-login-section"><div class="aer-box">
				...
				<div id="emailRegister">
					<div><?= aer_icons('email', 20, 20); ?><span>Cadastrar com email</span></div>
				</div>
...
<script>
	...
	document.querySelector('.reg_username input').addEventListener('keyup', (e) => cpfMask(e));
	...
	document.querySelectorAll('.woocommerce-form-register .form-row input[type="text"]').forEach(inp => inp.classList.add('aer-text-input'));
